...
-- footer
PRO<font class="n">Notes:<br>1) drag to zoom, and right click to reset<br>2) up to &&emd360_conf_days. days of awr history were considered</font>
...
-- zip
HOS zip -mq &&emd360_main_filename._&&emd360_file_time. &&one_spool_filename._line_chart.html
